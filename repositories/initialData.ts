...
export const Notes = {
    ...
    notes: [
        ...
        new Note(1, 'he theory of evolution', 'April 27, 2021', Categories.RANDOM_THOUGHT, 'The theory of evolution is a shortened form of the term “theory of evolution by natural selection,” which was proposed by Charles Darwin and Alfred Russel Wallace in the nineteenth century.'),
...
export const ArchiveNotes = {
    ...
    notes: [new Note(0, 'How improve engine', 'September 14, 2019', Categories.IDEA, 'Change valve travel')]
}